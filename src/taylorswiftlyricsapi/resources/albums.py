...
from ..types.album_retrieve_songs_response import AlbumRetrieveSongsResponse
    ...
    def retrieve_songs(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=AlbumRetrieveSongsResponse,
        )
...
class AlbumsResourceWithRawResponse:
    def __init__(self, albums: AlbumsResource) -> None:
        ...
        self.retrieve_songs = to_raw_response_wrapper(
            albums.retrieve_songs,
        )
...
class AsyncAlbumsResourceWithRawResponse:
    def __init__(self, albums: AsyncAlbumsResource) -> None:
        ...
        self.retrieve_songs = async_to_raw_response_wrapper(
            albums.retrieve_songs,
        )
...
class AlbumsResourceWithStreamingResponse:
    def __init__(self, albums: AlbumsResource) -> None:
        ...
        self.retrieve_songs = to_streamed_response_wrapper(
            albums.retrieve_songs,
        )
...
class AsyncAlbumsResourceWithStreamingResponse:
    def __init__(self, albums: AsyncAlbumsResource) -> None:
        ...
        self.retrieve_songs = async_to_streamed_response_wrapper(
            albums.retrieve_songs,
        )
